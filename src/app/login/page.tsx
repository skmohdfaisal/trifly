...
export const metadata = {
  title: "Log in to TRIFLY",
  description: "Log in to your TRIFLY account.",
};
      ...
      <div className="max-w-md w-full space-y-8 glass p-8 rounded-3xl border border-white/5 relative overflow-hidden">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-white/50">
            Log in to access your processed stems
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#0B1020] text-white/40">Or continue with email</span>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 rounded border-white/10 bg-white/5 text-primary focus:ring-primary focus:ring-offset-[#0B1020]"
                  />
